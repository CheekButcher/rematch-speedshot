...
// Class GameplayTags.GameplayTagFilterInterface
// 0x0000 (0x0000 - 0x0000)
class IGameplayTagFilterInterface final
{
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("GameplayTagFilterInterface")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"GameplayTagFilterInterface")
	}
	static class IGameplayTagFilterInterface* GetDefaultObj()
	{
		return GetDefaultObjImpl<IGameplayTagFilterInterface>();
	}
...
DUMPER7_ASSERTS_IGameplayTagFilterInterface;
...
public:
	...
	static void AddGameplayTagContainer(struct FGameplayTagContainer& TagContainer, const struct FGameplayTagContainer& TagContainerToAdd);
	...
	static bool NotEqual_TagTagPartial(const struct FGameplayTag& A, const class FString& B);
	static bool NotHasTag(const struct FGameplayTagContainer& TagContainer, const struct FGameplayTag& Tag, bool bExactMatch);
...
{
public:
	struct FGameplayTagContainer FilterExactGameplayTags(const struct FGameplayTagContainer& OtherContainer) const;
	struct FGameplayTagContainer FilterGameplayTags(const struct FGameplayTagContainer& OtherContainer) const;
...
// Class GameplayTags.EditableGameplayTagQueryExpression_AnyExactTagsMatch
// 0x0020 (0x0048 - 0x0028)
class UEditableGameplayTagQueryExpression_AnyExactTagsMatch final : public UEditableGameplayTagQueryExpression
{
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0028(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("EditableGameplayTagQueryExpression_AnyExactTagsMatch")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"EditableGameplayTagQueryExpression_AnyExactTagsMatch")
	}
	static class UEditableGameplayTagQueryExpression_AnyExactTagsMatch* GetDefaultObj()
	{
		return GetDefaultObjImpl<UEditableGameplayTagQueryExpression_AnyExactTagsMatch>();
	}
};
DUMPER7_ASSERTS_UEditableGameplayTagQueryExpression_AnyExactTagsMatch;

// Class GameplayTags.EditableGameplayTagQueryExpression_AllExactTagsMatch
// 0x0020 (0x0048 - 0x0028)
class UEditableGameplayTagQueryExpression_AllExactTagsMatch final : public UEditableGameplayTagQueryExpression
{
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0028(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("EditableGameplayTagQueryExpression_AllExactTagsMatch")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"EditableGameplayTagQueryExpression_AllExactTagsMatch")
	}
	static class UEditableGameplayTagQueryExpression_AllExactTagsMatch* GetDefaultObj()
	{
		return GetDefaultObjImpl<UEditableGameplayTagQueryExpression_AllExactTagsMatch>();
	}
};
DUMPER7_ASSERTS_UEditableGameplayTagQueryExpression_AllExactTagsMatch;

// Class GameplayTags.EditableGameplayTagQueryExpression_NoExactTagsMatch
// 0x0020 (0x0048 - 0x0028)
class UEditableGameplayTagQueryExpression_NoExactTagsMatch final : public UEditableGameplayTagQueryExpression
{
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0028(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("EditableGameplayTagQueryExpression_NoExactTagsMatch")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"EditableGameplayTagQueryExpression_NoExactTagsMatch")
	}
	static class UEditableGameplayTagQueryExpression_NoExactTagsMatch* GetDefaultObj()
	{
		return GetDefaultObjImpl<UEditableGameplayTagQueryExpression_NoExactTagsMatch>();
	}
};
DUMPER7_ASSERTS_UEditableGameplayTagQueryExpression_NoExactTagsMatch;
