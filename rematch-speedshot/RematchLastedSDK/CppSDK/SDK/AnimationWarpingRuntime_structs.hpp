...
public:
	...
	struct FFootPlacementTraceSettings            TraceSettings;                                     // 0x0180(0x001C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_19C[0x294];                                    // 0x019C(0x0294)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
