...
// 0x0008 (0x1EB8 - 0x1EB0)
class USteamNetConnection final : public UIpConnection
{
public:
	bool                                          bIsPassthrough;                                    // 0x1EB0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1EB1[0x7];                                     // 0x1EB1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
