...
#include "EQC_LastBallTrajectoryPosition_classes.hpp"
#include "EQC_LastBallTrajectoryPosition_parameters.hpp"
...
void UEQC_LastBallTrajectoryPosition_C::ProvideSingleLocation(class UObject* QuerierObject, class AActor* QuerierActor, struct FVector* ResultingLocation) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EQC_LastBallTrajectoryPosition_C", "ProvideSingleLocation");

	Params::EQC_LastBallTrajectoryPosition_C_ProvideSingleLocation Parms{};
