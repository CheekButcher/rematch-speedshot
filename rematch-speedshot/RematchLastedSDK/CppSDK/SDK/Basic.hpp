...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0885EB60;
	constexpr int32 AppendString      = 0x01040F10;
	constexpr int32 GNames            = 0x087A7740;
	constexpr int32 GWorld            = 0x089DD818;
	constexpr int32 ProcessEvent      = 0x012471A0;
