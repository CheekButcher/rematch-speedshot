...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0885F860;
	constexpr int32 AppendString      = 0x0103F4C0;
	constexpr int32 GNames            = 0x087A8440;
	constexpr int32 GWorld            = 0x089DE138;
	constexpr int32 ProcessEvent      = 0x01245820;
