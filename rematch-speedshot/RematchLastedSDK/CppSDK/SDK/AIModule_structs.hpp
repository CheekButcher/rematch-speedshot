...
public:
	...
	struct FGameplayTagContainer                  EventTags;                                         // 0x0048(0x0020)(BlueprintVisible, NativeAccessSpecifierPublic)
	uint8                                         Pad_68[0xC];                                       // 0x0068(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_74_0 : 1;                                   // 0x0074(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bSuccessfullySensed : 1;                           // 0x0074(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAIStimulus                            Stimulus;                                          // 0x0010(0x0078)(BlueprintVisible, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FGameplayTagContainer                  GameplayTags;                                      // 0x0040(0x0020)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
