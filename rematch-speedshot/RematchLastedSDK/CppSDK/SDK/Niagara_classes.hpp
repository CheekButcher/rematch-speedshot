...
public:
	...
	uint8                                         Pad_63C[0x54];                                     // 0x063C(0x0054)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableAttributeBinding       SectionIndexBinding;                               // 0x0690(0x0038)(Edit, NativeAccessSpecifierPublic)
...
public:
	...
	TMulticastInlineDelegate<void(class UNiagaraComponent* PSystem)> OnSystemFinished;               // 0x06A8(0x0010)(ZeroConstructor, InstancedReference, DuplicateTransient, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_6D5[0xEB];                                     // 0x06D5(0x00EB)(Fixing Size After Last Property [ Dumper-7 ])
