...
struct EQC_TeamGoalWithOffset_C_ProvideSingleLocation final
{
public:
	...
	class AEQSTestingPawn*                        K2Node_DynamicCast_AsEQSTesting_Pawn;              // 0x0048(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         CallFunc_BPF_GetTeam_ReturnValue;                  // 0x0071(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class AGoal*>                          CallFunc_GetAllActorsOfClass_OutActors;            // 0x0090(0x0010)(ReferenceParm)
	...
	class AGoal*                                  CallFunc_Array_Get_Item;                           // 0x00A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class USCWorldSubsystem*                      CallFunc_BPF_GetWorldSubsystem_ReturnValue;        // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class URuntimeAISubsystem*                    K2Node_DynamicCast_AsRuntime_AISubsystem;          // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AGoal*                                  CallFunc_BPF_GetTeamGoal_ReturnValue;              // 0x00F8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_EQC_TeamGoalWithOffset_C_ProvideSingleLocation;
