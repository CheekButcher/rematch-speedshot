...
class UAIPerceptionComponent* AAIController::GetAIPerceptionComponent() const
{
	static class UFunction* Func = nullptr;
...
// Function AIModule.BrainComponent.PauseLogic
...
void UBrainComponent::PauseLogic(const class FString& Reason)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BrainComponent", "PauseLogic");

	Params::BrainComponent_PauseLogic Parms{};
...
// Function AIModule.BrainComponent.ResumeLogic
// (RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// const class FString&                    Reason                                                 (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EAILogicResuming                        ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

EAILogicResuming UBrainComponent::ResumeLogic(const class FString& Reason)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BrainComponent", "ResumeLogic");

	Params::BrainComponent_ResumeLogic Parms{};
...
bool UAIPerceptionComponent::GetActorsPerception(const class AActor* Actor, struct FActorPerceptionBlueprintInfo* Info) const
{
	static class UFunction* Func = nullptr;
...
// Function AIModule.AIPerceptionComponent.GetKnownPerceivedStimulus
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// TSubclassOf<class UAISense>             SenseToUse                                             (Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<struct FVector>*                 OutLocations                                           (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)

void UAIPerceptionComponent::GetKnownPerceivedStimulus(TSubclassOf<class UAISense> SenseToUse, TArray<struct FVector>* OutLocations) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AIPerceptionComponent", "GetKnownPerceivedStimulus");

	Params::AIPerceptionComponent_GetKnownPerceivedStimulus Parms{};
...
void UAISense_Hearing::ReportNoiseEvent(class UObject* WorldContextObject, const struct FVector& NoiseLocation, float Loudness, class AActor* Instigator, float MaxRange, class FName Tag, const struct FGameplayTagContainer& EventTags)
{
	static class UFunction* Func = nullptr;
