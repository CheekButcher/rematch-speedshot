...
// 0x04E8 (0x0870 - 0x0388)
class alignas(0x10) UEOSDefaultUserInterface_EnterDevicePinCode final : public UUserWidget
{
public:
	uint8                                         Pad_388[0x418];                                    // 0x0388(0x0418)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateFontInfo                         TitleFont;                                         // 0x07A0(0x0060)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateFontInfo                         RegularFont;                                       // 0x0800(0x0060)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UEOSUserInterface_EnterDevicePinCode_Context* Context;                                     // 0x0860(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// 0x04C8 (0x0850 - 0x0388)
class alignas(0x10) UEOSDefaultUserInterface_SignInOrCreateAccount final : public UUserWidget
{
public:
	uint8                                         Pad_388[0x3F8];                                    // 0x0388(0x03F8)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateFontInfo                         TitleFont;                                         // 0x0780(0x0060)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateFontInfo                         RegularFont;                                       // 0x07E0(0x0060)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UEOSUserInterface_SignInOrCreateAccount_Context* Context;                                  // 0x0840(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
