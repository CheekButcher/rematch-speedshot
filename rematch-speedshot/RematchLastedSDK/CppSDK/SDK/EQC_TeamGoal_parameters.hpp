...
struct EQC_TeamGoal_C_ProvideSingleLocation final
{
public:
	...
	class AGoal*                                  CallFunc_Array_Get_Item;                           // 0x0090(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_EQC_TeamGoal_C_ProvideSingleLocation;
