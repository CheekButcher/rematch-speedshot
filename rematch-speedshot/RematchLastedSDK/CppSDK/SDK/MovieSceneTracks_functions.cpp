...
TArray<class FName> UMovieScene3DAttachSection::GetPresetArray() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MovieScene3DAttachSection", "GetPresetArray");

	Params::MovieScene3DAttachSection_GetPresetArray Parms{};
