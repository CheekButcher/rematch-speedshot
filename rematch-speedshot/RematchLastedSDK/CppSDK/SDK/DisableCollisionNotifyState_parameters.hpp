...
struct DisableCollisionNotifyState_C_Received_NotifyBegin final
{
public:
	...
	class ARuntimeCharacter*                      K2Node_DynamicCast_AsRuntime_Character;            // 0x0060(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_DisableCollisionNotifyState_C_Received_NotifyBegin;

// Function DisableCollisionNotifyState.DisableCollisionNotifyState_C.Received_NotifyEnd
// 0x0068 (0x0068 - 0x0000)
struct DisableCollisionNotifyState_C_Received_NotifyEnd final
{
public:
	class USkeletalMeshComponent*                 MeshComp;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                      Animation;                                         // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_DisableCollisionNotifyState_C_Received_NotifyEnd;
