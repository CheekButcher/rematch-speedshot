...
// 0x0028 (0x0028 - 0x0000)
struct BlendStackAnimNodeLibrary_GetCurrentBlendStackBlendParameters final
{
public:
	struct FBlendStackAnimNodeReference           Node;                                              // 0x0000(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                ReturnValue;                                       // 0x0010(0x0018)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_BlendStackAnimNodeLibrary_GetCurrentBlendStackBlendParameters;
