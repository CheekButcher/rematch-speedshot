...
struct WBP_Menu_CallToAction_C_PreConstruct final
{
public:
	bool                                          IsDesignTime;                                      // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_WBP_Menu_CallToAction_C_PreConstruct;

// Function WBP_Menu_CallToAction.WBP_Menu_CallToAction_C.ExecuteUbergraph_WBP_Menu_CallToAction
// 0x0038 (0x0038 - 0x0000)
struct WBP_Menu_CallToAction_C_ExecuteUbergraph_WBP_Menu_CallToAction final
{
public:
...
DUMPER7_ASSERTS_WBP_Menu_CallToAction_C_ExecuteUbergraph_WBP_Menu_CallToAction;
