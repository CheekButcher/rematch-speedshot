...
// Function EQC_EnemyGoal.EQC_EnemyGoal_C.ProvideSingleLocation
// 0x0100 (0x0100 - 0x0000)
struct EQC_EnemyGoal_C_ProvideSingleLocation final
{
public:
	...
	uint8                                         CallFunc_BPF_GetTeam_ReturnValue;                  // 0x0072(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class AGoal*>                          CallFunc_GetAllActorsOfClass_OutActors;            // 0x0078(0x0010)(ReferenceParm)
	class AGoal*                                  CallFunc_Array_Get_Item;                           // 0x0088(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class USCWorldSubsystem*                      CallFunc_BPF_GetWorldSubsystem_ReturnValue;        // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class URuntimeAISubsystem*                    K2Node_DynamicCast_AsRuntime_AISubsystem;          // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AGoal*                                  CallFunc_BPF_GetEnemyTeamGoal_ReturnValue;         // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_EQC_EnemyGoal_C_ProvideSingleLocation;
