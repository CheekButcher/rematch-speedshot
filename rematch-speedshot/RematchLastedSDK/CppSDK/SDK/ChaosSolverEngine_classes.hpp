...
public:
	...
	class UChaosGameplayEventDispatcher*          GameplayEventDispatcherComponent;                  // 0x03A0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
